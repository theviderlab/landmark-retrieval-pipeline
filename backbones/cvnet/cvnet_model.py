...
class CVNet_Rerank(nn.Module):
    ...
    def extract_backbone_stages(self, img):
        """
        Devuelve un OrderedDict con los feature maps 'res2', 'res3', 'res4' y 'res5',
        obtenidos de los bloques finales de s2, s3, s4 y s5 respectivamente.
        Totalmente compatible con FPN de Detectron2.
        """
        with torch.no_grad():
            # Para ResNet-50:
            # - res2: hid+1 == 3
